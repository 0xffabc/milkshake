...
class CameraEntity(
  ...
  public fun setAngles(yaw: Float, pitch: Float) {
    this.yaw = yaw
    this.pitch = pitch
  }
}
...
object FreeCam {
  ...
  internal fun synchronizeMovement() {
    ...
    val vec = movementVec.multiply(1.0 / 6.0).add(
      camEntity.getPos()
    )

    camEntity.setPos(vec.x, vec.y, vec.z)
  }
  ...
  private fun setCamera() {
    ...
    world.addEntity(Int.MAX_VALUE, camEntity as Entity)
  }
